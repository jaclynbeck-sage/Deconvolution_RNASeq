...
#           For HSPE, as many cores as will fit in RAM. Assume between 5-20 GB
#           of RAM needed per core, depending on the dataset. HSPE also multi-
#           threads so a lower number of cores could be used.
alg_config <- list(
