...
# machine. This is necessary because while I upload pre-processed data sets to
# Synapse, these do not include the clinical metadata that may be protected
...
for (dataset in datasets) {
  ...
  saveRDS(covariates,
          file.path(dir_covariates, str_glue("{dataset}_covariates.rds")))
}
